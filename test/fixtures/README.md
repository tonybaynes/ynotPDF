...
## Synthetic files added by M53

| File       | Exercises                                                                                                                                                                                                                                                |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `urls.pdf` | Twelve web and e-mail addresses written in prose across two pages, plus three traps: a version number, a footnote marker, and one address that is already a Link annotation. The link detector must find the twelve, once each, and leave the last alone |
