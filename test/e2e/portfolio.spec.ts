...
import { realpathSync, copyFileSync, existsSync, mkdtempSync, readFileSync, rmSync } from 'node:fs';
...
test.beforeAll(async () => {
  workspace = realpathSync.native(mkdtempSync(join(tmpdir(), 'ynot-portfolio-')));
  app = await launchApp();
