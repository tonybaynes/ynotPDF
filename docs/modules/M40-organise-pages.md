...
Provenance (Tony's rule, 2026-09-09): the behaviour below comes from the PDF specification
...
- `resources/credits.json` — **new**, per Tony's 2026-09-09 rule: the icon sets and fonts
