...
import decorationsManifest from '@modules/M53-headers-bates-watermarks-links/manifest';
...
registry.register(measuringManifest);
...
registry.register(decorationsManifest);
